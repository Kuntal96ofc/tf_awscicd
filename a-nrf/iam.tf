//IAM Roles Creation for oai-nrf module

resource "aws_iam_role" "nrf_build" {
  name = "nrf-build-terraform"
...
resource "aws_iam_role_policy" "AmazonEC2ContainerRegistryFullAccess" {
  role = aws_iam_role.nrf_build.name
...
resource "aws_iam_role_policy" "CodeBuildBasePolicy-oai-build-ap-southeast-1" {
  role = aws_iam_role.nrf_build.name
    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Resource": [
                "arn:aws:logs:ap-southeast-1:*:log-group:/aws/codebuild/oai_nrf_build",
                "arn:aws:logs:ap-southeast-1:*:log-group:/aws/codebuild/oai_nrf_build:*"
            ],
            "Action": [
                "logs:CreateLogGroup",
        ...
        },
        {
            "Effect": "Allow",
            "Resource": [
                "arn:aws:codecommit:ap-southeast-1:*:oai-nrf"
            ],
            "Action": [
                "codecommit:GitPull"
            ]
        },
        {
            ...
            "Resource": [
                "arn:aws:codebuild:ap-southeast-1:*:report-group/oai-nrf-terraform-*"
            ]
        }
    ]
}
...
//IAM Roles Creation for oai-nrf-sonar module

resource "aws_iam_role" "nrf_sonar_build" {
  name = "nrf-sonar-terraform"
...
resource "aws_iam_role_policy" "AmazonS3FullAccessforSonarQube" {
  role = aws_iam_role.nrf_sonar_build.id
...
resource "aws_iam_role_policy" "CodeBuildBasePolicy-oai-nrf-sonarbuild" {
  role = aws_iam_role.nrf_sonar_build.id
  ...
  policy = <<POLICY
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": [
                "arn:aws:logs:ap-southeast-1:*:log-group:/aws/lambda/PipelineApprovalNotification_terraform:*"
            ]
        }
    ]
}
  ...
  policy = <<POLICY
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": [
                "arn:aws:logs:ap-southeast-1:*:log-group:/aws/lambda/PipelineMailnotification_terraform:*"
            ]
        }
    ]
}
  ...
  policy = <<POLICY
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": [
                "arn:aws:logs:ap-southeast-1:*:log-group:/aws/lambda/LambdaForSecurityHub:*"
            ]
        }
    ]
}
...
resource "aws_iam_role" "nrf_pipeline_iam" {
  name = "nrf-pipeline-terraform"
...
resource "aws_iam_role_policy" "nrf_pipeline_iam" {
  role = aws_iam_role.nrf_pipeline_iam.name
