//IAM Roles Creation for oai-gnbsim module

resource "aws_iam_role" "gnbsim_build" {
  name = "gnbsim-build-terraform"
...
resource "aws_iam_role_policy" "AmazonEC2ContainerRegistryFullAccess" {
  role = aws_iam_role.gnbsim_build.name
    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Resource": [
                "arn:aws:logs:<AWSRegion>:*:log-group:/aws/codebuild/oai_gnbsim_build",
                "arn:aws:logs:<AWSRegion>:*:log-group:/aws/codebuild/oai_gnbsim_build:*"
            ],
            "Action": [
                "logs:CreateLogGroup",
        ...
        },
        {
            "Effect": "Allow",
            "Resource": [
                "arn:aws:codecommit:<AWSRegion>:*:oai-gnbsim"
            ],
            "Action": [
                "codecommit:GitPull"
            ]
        },
        {
            ...
            "Resource": [
                "arn:aws:codebuild:<AWSRegion>:*:report-group/oai-gnbsim-terraform-*"
            ]
        }
    ]
}
...
//IAM Roles Creation for oai-gnbsim-sonar module

resource "aws_iam_role" "gnbsim_sonar_build" {
  name = "gnbsim-sonar-terraform"
...
resource "aws_iam_role_policy" "AmazonS3FullAccessforSonarQube" {
  role = aws_iam_role.gnbsim_sonar_build.id
...
resource "aws_iam_role_policy" "CodeBuildBasePolicy-oai-gnbsim-sonarbuild" {
  role = aws_iam_role.gnbsim_sonar_build.id
...
resource "aws_iam_role" "gnbsim_pipeline_iam" {
  name = "gnbsim-pipeline-terraform"
...
resource "aws_iam_role_policy" "gnbsim_pipeline_iam" {
  role = aws_iam_role.gnbsim_pipeline_iam.name
